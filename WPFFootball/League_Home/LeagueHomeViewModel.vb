...
#Region "Commands"
    ...
    Public Sub LgEvent()
        ...
        MyDT.Clear()
        ReadFile("../../Data_Files/LeagueEvents.Txt", ColNames, TempDT, "ddd MMMM dd, yyyy", 0)
        MyDT.Add(TempDT)
    End Sub
    ...
    Private Sub LgTrans()
        ...
        ReadFile("../../Data_Files/LeagueTrans.Txt", ColumnNames, TempDT, "M/dd", 1, "Trans Date DESC")
        MyDT.Add(TempDT)
    End Sub
    ''' <summary>
    ...
    Private Sub LgInjuries()
        ...
        ReadFile("../../Data_Files/LeagueInj.Txt", ColumnNames, TempDT, "M/dd", 1, "Inj Date DESC")
        MyDT.Add(TempDT)
    End Sub
    ...
    Private Sub LgMilestones()
        ...
        ReadFile("Data_Files/LeagueMile.Txt", ColumnNames, TempDT, "M/dd", 1, "Milestone Date DESC")
        MyDT.Add(TempDT)
    End Sub
    ''' <summary>
