...
Public Class CollegePlayers
    ...
    Public Sub GenDraftPlayers(ByVal playerNum As Integer, ByVal xCollegePlayer As CollegePlayers, ByVal draftDT As DataTable)
        ...
        Try
            ...
            draftDT.Rows(playerNum).Item("BroadJump") = GetBroadJump(MyPos, DraftRound)
            draftDT.Rows(playerNum).Item("VertJump") = GetVertJump(MyPos, DraftRound)
            draftDT.Rows(playerNum).Item("ThreeConeDrill") = Get3Cone(MyPos, DraftRound)
            draftDT.Rows(playerNum).Item("BenchPress") = GetBenchPress(MyPos, DraftRound)
    ...
    Public Shared Function GetShortShuttle(ByVal pos As String, ByVal DraftRound As String) As Double
        Dim Result As Double
        Select Case pos
            Case "QB"
                Select Case DraftRound
    ...
    Private Shared Function Get10Time(ByVal pos As String, DraftRound As String) As Double
        Dim Result As Double
        Select Case pos
            Case "QB"
                Select Case DraftRound
